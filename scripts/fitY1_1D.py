...
#else:
dirxi = '/global/cfs/cdirs/desi/survey/catalogs/Y1/LSS/iron/LSScats/'+catver+blinded+args.smooth+'/xi/smu/'

dircov = '/global/cfs/cdirs/desi/users/mrash/RascalC/Y1'+blinded+'/'+args.covver

outdir = '/global/cfs/cdirs/desi/science/Y1KP/BAO/'+catver+blinded+args.smooth+'/AJR/'
